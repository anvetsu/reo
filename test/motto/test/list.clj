...
(deft take-test
  ["lift(2, [1 2 3 4])"     [1 2]
   ...
   "lift(2 \"hello\")"     [\h \e]
   "lift(-2 \"hello\")"    [\l \o]
   "takeRepeat(5 1)"    [1 1 1 1 1]
   "takeRepeat(30 [1 5 0 0])"
...
(deft fold-test
  ["op+@ [1 2 3 4 5]" 15
   "op+@ 10;til(6)" 25
   "op*@ 1+til(10)" 3628800
   "op*@ takeRepeat(2 1.4142135623730949)" 1.9999999999999996
   "op+@[[4 8] [1 4] 10 [9 5]]" [24 27]
   "op+@[[4 8] [1 4] [1 2 3] [9 5]]" [15 19]
   "n:5"            'n
   "op*@ takeRepeat(n 10)"      100000
   "big@ [20 10 30 40]" 40
   "sml@ [20 10 30 40]" 10
...
(deft fold-incr
  ["op+@~ [1 2 3 4 5]" [1 3 6 10 15]
   "op+@~ 10;til(6)" [10 10 11 13 16 20 25]])
